...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Oct 2020 12:37:01 GMT -->
<head>
            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="users"></i><span>Drivers</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="driver-list.html"><i class="fa fa-circle"></i>Drivers List</a></li>
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="users"></i><span>Distros</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="distro-list.html"><i class="fa fa-circle"></i>Distro List</a></li>
                ...
                <div class="p-l-30 p-r-30">
                    <div class="chat-box">
                        <div class="people-list friend-list">
                            <ul class="list">
                                <li class="clearfix"><img class="rounded-circle user-image blur-up lazyloaded" src="user.png" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image blur-up lazyloaded" src="user1.jpg" alt="">
                            ...
                            <div class="card-body order-datatable">
                                <table class="display" id="basic-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <img src="25.jpg" alt="" class="img-fluid img-30 mr-2 blur-up lazyloaded">
                                                <img src="13.jpg" alt="" class="img-fluid img-30 mr-2 blur-up lazyloaded">
                                                <img src="16.jpg" alt="" class="img-fluid img-30 blur-up lazyloaded">
                                            </div>
                                        </td>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Oct 2020 12:38:19 GMT -->
</html>
